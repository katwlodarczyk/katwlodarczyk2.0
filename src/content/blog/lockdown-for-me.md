...
- Took part in women in tech event, and could listen to Pauline talk about blogging ([watch it here!](https://www.youtube.com/watch?v=fybQ2oId1I4))
- Learned to create [digital portraits](https://katcodes.home.blog/2020/04/05/how-to-create-a-digital-portrait/)
- Recorded and published [2 youtube videos](https://www.youtube.com/channel/UCgRwgJ0CbN8uyHdEaSMqK6Q)
- Published my portfolio [website](https://katwlodarczyk.com/)
- Practices JS and did a fun [quiz](https://katwlodarczyk.github.io/holiday-destination-quiz/)
- Bought my first raspberry pi and built the scroll bot ([read about it here](https://katcodes.home.blog/2020/06/02/raspberry-pi-scroll-bot-soldering-building-coding/))
...
Illustrations used in the post are from [ManyPixels](https://www.manypixels.co/gallery/)